...
# LuaLib is built dynamically because it contains the version of the package
$(CLASSDIR)/LuaLib.class: $(SRCDIR)/LuaLib.java
	$(JAVAC) $(JAVAC_FLAGS) $<

# forceit forces LuaLib.java to be regenerated all the time (even if it already exists)
$(SRCDIR)/LuaLib.java: $(SRCDIR)/LuaLib.template forceit
...
clean: cleanh cleanb
	...
	rm -f $(SRCDIR)/LuaLib.java # this file is automatically generated
